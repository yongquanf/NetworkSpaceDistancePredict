 ...
 * @since   LingPipe1.0
 */
public class Math_cluster {

    // forbid instances
    private Math_cluster() {
        /* no instances */
    }
     ...
     */
    public static final double LOG2_E = edu.NUDT.PDL.cluster.Math_cluster.log2(java.lang.Math.E);
    ...
    public static double log2Gamma(double z) {
        if (z < 0.5) {
            return edu.NUDT.PDL.cluster.Math_cluster.log2(java.lang.Math.PI)
                - edu.NUDT.PDL.cluster.Math_cluster.log2(java.lang.Math.sin(java.lang.Math.PI * z))
                - log2Gamma(1.0 - z);
        }
        double result = 0.0;
        while (z > 1.5) {
            result += edu.NUDT.PDL.cluster.Math_cluster.log2(z - 1);
            z -= 1.0;
        }
        return result + edu.NUDT.PDL.cluster.Math_cluster.log2(lanczosGamma(z));
    }
