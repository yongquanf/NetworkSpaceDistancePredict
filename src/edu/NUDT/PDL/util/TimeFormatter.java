...
public class TimeFormatter {
  // XXX should be i18n'd
	...
	public static String format(long time_secs) {
		if (time_secs == CRAPPY_INFINITY_AS_INT || time_secs >= CRAPPY_INFINITE_AS_LONG)
    ...
    {
      if (time == CRAPPY_INFINITY_AS_INT || time >= CRAPPY_INFINITE_AS_LONG) return INFINITY_STRING;
      if (time < 0) return "";
