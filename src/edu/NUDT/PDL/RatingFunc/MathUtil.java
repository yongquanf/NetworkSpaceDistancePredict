...
public class MathUtil {
	 ...
	 * @return
	 */
	public double mean(Vector<Float> v) {
		double sum = 0;
		if (v.size() == 0) {
	 ...
	 * @return
	 */
	public double stddev(Vector<Float> v, double mean) {
		double sum = 0.;
		float k;
		if (v.size() <= 1)
			return 0.;
	 ...
	 * @return
	 */
	public double stddev(Float[][] v, double mean) {
		double sum = 0.;
		float k;
		if (v == null) {
	 ...
	 * @return
	 */
	public double percentile(Vector v, double percentile) {
		int index = -1;
		if (v==null||v.size() == 0) {
			return Double.MAX_VALUE;
		}
	...
	/**
	 * compute percentiles for a set of nodes
	 * @param v
	 * @param percentiles
	 * @return
	 */
	public Vector<Double> percentile(Vector<Double> v, Vector<Double> percentiles) {
		
		/**
		 * vec size
		 */
		Vector<Double> vec=new Vector<Double>(percentiles.size());
