...
public class CgLineSearch4_oneHost_Bias {

	int verbose=1;
	
	static  CgLineSearch4_oneHost_Bias self=null;
	public static  CgLineSearch4_oneHost_Bias getInstance(){
		if(self==null){
			self=new  CgLineSearch4_oneHost_Bias();
		}
		return self;
	}
	...
	public void compute(Vector x0,double[] obj2,
			Vector dx0, Vector direction, BiasMatrixRatingGradient ogfun,			
...
(Conjgrad_gradient.pround(obj[0],digits) <= Conjgrad_gradient.pround(obj0[0],digits)) &&
	...
	private void backtrack(Vector x,double[] obj,
			Vector dx,Vector direction, BiasMatrixRatingGradient ogfun,
