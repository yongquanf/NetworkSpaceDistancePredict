...
public class CgLineSearch {
		
		int verbose=1;
		
		static CgLineSearch self=null;
		public static  CgLineSearch getInstance(){
			if(self==null){
				self=new  CgLineSearch();
			}
			return self;
		}
		...
		public void compute(Vector x0,double[] obj2,
				Vector dx0, Vector direction, m3fshc ogfun,			
	...
	(Conjgrad_gradient.pround(obj[0],digits) <= Conjgrad_gradient.pround(obj2[0],digits)) &&
		...
		private void backtrack(Vector x,double[] obj,
				Vector dx,Vector direction, m3fshc ogfun,
