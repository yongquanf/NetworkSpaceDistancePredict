...
public class SntpClient
{
	 ...
	 * @throws IOException
	 */
	public static long getOffset(String serverName) throws SocketException,
		...
		// Get response
		if (DEBUG) System.out.println("NTP request sent, waiting for response...\n");
